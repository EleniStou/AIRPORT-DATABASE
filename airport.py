...
def get_arrivals(y):
    try:
        ...
        with conn:
            cur = conn.cursor()
            cur.execute("SELECT F.id_flight,name_terminal,AL.name_airline,AI.name_airplane,L2.time_line,time(F.date_flight),AL.country,\
                        CASE \
...
if __name__ == '__main__':
    print("Καλώς ήρθατε στο αεροδρόμιο μας !")
    print()
    while True:
        _ = system('clear')
        ...
        if x == "a":
            ...
            while not validate(y):
                ...
                print()
            l = ["Flight no.","Terminal","Airline ", "Airplane" , "Time_Scheduled"," Time_expected", "From",'Via']
            print("----------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
            print('{:<15s}{:<19s}{:<31s}{:<20s}{:<22s}{:<22s}{:<28s}{:<28s}'.format(l[0],l[1],l[2],l[3],l[4],l[5],l[6],l[7]))
            print("----------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
            for row in get_arrivals(y):
                print('{:<15d}{:<19s}{:<31s}{:<20s}{:<22s}{:<22s}{:<28s}{:<28s}'.format(row[0],row[1],row[2],row[3],row[4],row[5],row[6],row[7]))
            print()    
            ...
            while z != "":
                ...
                if z == "1":
                    ...
                    print("-----------------------------------------------------------------------------------------------------------------------------------------------")
                    print('{:<21s}{:<18s}{:<25s}{:<18s}{:<25s}{:<25s}{:<18s}'.format(l[0],l[1],l[2],l[3],l[4],l[5],l[6]))
                    print("-----------------------------------------------------------------------------------------------------------------------------------------------")
                    for row in get_info_airline(z2):
                        print('{:<21s}{:<18s}{:<25s}{:<18s}{:<25s}{:<25s}{:<18d}'.format(row[0],row[1],row[2],row[3],row[4],row[5],row[6]))
                    print()
                elif z == "2":
            ...
            while not validate(y):
                y = input("Λανθασμένη μορφή ημερομηνίας, δώσε την ημερομηνία σε σωστή μορφή YYYY-MM-DD:")
                print()
            l = ["Flight no.","Terminal","Airline ", "Airplane" , "Time_Scheduled"," Time_expected", "To","Via"]
            print("-------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
            print('{:<15s}{:<19s}{:<31s}{:<20s}{:<22s}{:<22s}{:<28s}{:<28s}'.format(l[0],l[1],l[2],l[3],l[4],l[5],l[6],l[7]))
            print("-------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
